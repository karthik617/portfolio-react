  ...
  return (
    <>
      <div className="work-experience d-flex">
        ...
        <div className="git-line-wk rounded mx-auto"></div>
          <div className="mx-auto my-3 icon-container-ed">
            <div className="position-relative d-inline-block">
              ...
              <span className="position-absolute glowing-icon-glow-wk"></span>
            </div>
          </div>
          <div className="git-line-wk rounded mx-auto"></div>
        </div>
        <div className="d-flex flex-column">
          <h2 className="mt-5 mb-2">Work Experience</h2>
          <h3 className="mt-2 mb-6">
            Currently working at{" "}
            <span className="text-color">Code Array Pvt.Lmt</span> {" "}
            Kanjurmarg
          </h3>
        </div>
      </div>
